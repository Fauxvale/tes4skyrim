...
Usage:
    python tools/spt_billboard_dump.py                     # every billboard
    python tools/spt_billboard_dump.py --trees maniatree01 dtree01
    python tools/spt_billboard_dump.py --plugin Nehrim.esm --out temp/bb
"""
