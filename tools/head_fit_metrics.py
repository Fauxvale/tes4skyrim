...
Usage:
  python -m tools.head_fit_metrics <mesh.nif> [<mesh.nif> ...]
  python -m tools.head_fit_metrics --shipped                 # sweep output/
  python -m tools.head_fit_metrics --shipped --race khajiit
  python -m tools.head_fit_metrics --shipped --group elves --max 12
  python -m tools.head_fit_metrics <mesh.nif> --female --dump 6
