...
intact.
    ...
    python tools/nif_count_audit.py a.nif b.nif

    # audit a tree, or a list of paths from a file
    python tools/nif_count_audit.py output/Foo.esm/meshes --max 5000
    python tools/nif_count_audit.py --list temp/cellmeshes.txt --root output/Foo.esm/meshes/tes4
