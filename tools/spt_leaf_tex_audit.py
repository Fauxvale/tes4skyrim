...
Usage:
    python tools/spt_leaf_tex_audit.py                   # every export/ plugin
    python tools/spt_leaf_tex_audit.py -f TamRes.esm     # one plugin
    python tools/spt_leaf_tex_audit.py --show-ok         # list resolved too
"""
import argparse
import sys
