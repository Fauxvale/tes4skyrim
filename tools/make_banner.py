...
Usage:
    python tools/make_banner.py [--svg docs/banner.svg] [--png docs/banner.png]
...
measured from the vanilla Dwemer puzzle cube that `tools/make_app_icon.py`
...
import dwemer_palette  # noqa: E402  (needs the path above)
...
# never drift apart. See tools/dwemer_palette.py for the measurements.
