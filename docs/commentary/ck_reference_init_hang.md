...
- [✅ DIAGNOSED (2026-08-22, second session) — it is a CRASH, not a deadlock](#diagnosed-crash-not-deadlock)
- [🛑 Read this first (2026-08-22, second session)](#read-this-first)
- [Top-level group order — 1,852 references silently deleted (FIXED)](#top-level-group-order-1852)
- [What "Initializing References" actually is (decompiled 2026-08-22)](#what-initializing-references-actually)
- [Status](#status)
- [How to reproduce](#how-reproduce)
- [Live-hang diagnostic methodology (SUPERSEDED — history only)](#live-hang-diagnostic-methodology)
- [The 4 confirmed data bugs (fixed, keep regardless of hang outcome)](#4-confirmed-data-bugs)
- [Ruled out (don't re-try without new evidence)](#ruled-out)
- [Why not our data (the case for a CKPE-side bug)](#why-not-our-data)

## ✅ DIAGNOSED (2026-08-22, second session) — it is a CRASH, not a deadlock
<a id="diagnosed-crash-not-deadlock"></a>
...
<a id="top-level-group-order-1852"></a>
...
<a id="live-hang-diagnostic-methodology"></a>
