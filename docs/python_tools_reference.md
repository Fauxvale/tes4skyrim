...
- **CharacterGen debug**: `python tools/chargen_debug.py` — instruments the converted CharacterGen scripts with exhaustive SKSE logging into a single diagnosable log.
